#PCA delimita cuales son los features que mas peso tienen en el modelos
...
if __name__ == "__main__":
    ...
    #split de los datos, random state lo dejamps como un numero fijo para repetibilidad
